...
const Nosotros = () => {
  return (
    <div className=" flex flex-col px-96 mx-24">
      ...
      <p className="text-2xl py-2  text-slate-600 max-w-prose" >Disfruta la comodidad de comprar en línea sin salir de casa, envíos rápidos y seguros</p>
      <p className="text-2xl py-2  text-slate-600 max-w-prose mb-20" > ¡Haz tu mejor compra ahora!</p>
